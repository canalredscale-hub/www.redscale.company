...
- Ultima aprovacao: na secao `Sobre`, o texto principal deve ganhar um reforco minimo de peso, as bordas dos cards devem ir para um cinza claro e, cerca de `3,5cm` abaixo da esteira, devem surgir duas frases de efeito em alinhamentos distintos.
- Proximo passo: validar no preview se o ajuste fino do peso do texto principal, o novo contraste das bordas e o posicionamento das duas frases ficaram equilibrados antes de seguir para a proxima secao da home.
...
4. Secao Sobre.
   ...
   Frases de efeito atuais: cerca de `3,5cm` abaixo da esteira surgem as frases `Clareza para decidir.` e `Simplicidade para crescer.` em `Playfair Display`, tamanho responsivo entre `44px` e `72px`, cor `#262626`; a primeira comeca alinhada ao mesmo recuo do bloco principal do `Sobre`, e a segunda comeca mais a direita, usando como referencia o canto direito da capsula fixa central do header.
