...
- Ultima aprovacao: no bloco complementar da secao `Sobre`, os textos de apoio devem quebrar so mais aproximadamente `0,5cm`, fechando o ajuste fino dessa area.
- Proximo passo: seguir para a proxima secao da home, mantendo o bloco complementar do `Sobre` como referencia aprovada.
