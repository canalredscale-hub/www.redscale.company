...
- Ultima aprovacao: no bloco complementar da secao `Sobre`, os textos de apoio devem quebrar ainda mais cedo, em mais aproximadamente `2cm` sobre o ajuste atual.
- Proximo passo: validar no preview se a quebra agora mais fechada dos textos cinza continua confortavel e equilibrada nas duas colunas.
