...
- Ultima aprovacao: no bloco complementar da secao `Sobre`, os textos de apoio devem quebrar cerca de `0,5cm` antes da largura do titulo e o bloco da direita deve seguir a mesma regua de alinhamento do bloco da esquerda.
- Proximo passo: validar no preview se as novas quebras dos textos cinza ficaram mais elegantes e se o bloco da direita realmente passou a conversar com a mesma largura-base do bloco esquerdo.
