...
- Ultima aprovacao: no bloco complementar da secao `Sobre`, os textos de apoio devem quebrar ainda mais cedo, em mais aproximadamente `2cm` sobre o ajuste anterior.
- Proximo passo: validar no preview se a nova quebra mais recuada dos textos cinza ficou elegante sem comprimir demais a leitura dos dois blocos.
